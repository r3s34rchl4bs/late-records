...
function rowHTML(item, query, isSuggestion) {
  ...
  return `<tr class="${sold ? 'sold' : ''}${isSuggestion ? ' is-suggestion' : ''}"
    ...
    <td class="c-art"><div class="rec-art-wrap"><img src="images/${encodeURIComponent(item.album_id)}.jpg" alt="" loading="lazy" onerror="this.parentNode.style.opacity='0'"></div></td>
